...
metadata_tiles <- ggplot(barplot_results$dataframe) + 
  ...
  labs(fill = "Timepoint")+
  geom_tile(aes(x = reorder(contrast_name, -abs(total_DEGs)), y = 1, fill = barplot_results$dataframe$positive_contrast_timepoint)) +
  geom_tile(aes(x = reorder(contrast_name, -abs(total_DEGs)), y = 2, fill = barplot_results$dataframe$negative_contrast_timepoint)) +
  ...
  labs(fill = "Vaccine")+
  geom_tile(aes(x = reorder(contrast_name, -abs(total_DEGs)), y = 3, fill = barplot_results$dataframe$positive_contrast_vaccine_cohort)) +
  geom_tile(aes(x = reorder(contrast_name, -abs(total_DEGs)), y = 4, fill = barplot_results$dataframe$negative_contrast_vaccine_cohort)) +
  ggnewscale::new_scale_fill() +
