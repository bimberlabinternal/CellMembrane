...
print('This is the WD:')
print(here::here())
print("Testing to see if the test directory is mounted properly:")
print(here::here("../tests/"))
print("Listing local files/directories:")
print(list.files(here::here("../")))

#Load seurat object
seuratObj <- suppressMessages(suppressWarnings(
    Seurat::UpdateSeuratObject(readRDS(here::here("../tests/testdata/seuratOutput.rds")))
))
