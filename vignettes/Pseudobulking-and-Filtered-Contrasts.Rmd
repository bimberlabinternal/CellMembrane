...
#Load seurat object
seuratObj <- suppressMessages(suppressWarnings(Seurat::DietSeurat(SeuratObject::JoinLayers(Seurat::UpdateSeuratObject(readRDS("../tests/testdata/seuratOutput.rds"))))))
