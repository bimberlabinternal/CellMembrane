...
#'  CD3E_positive <- WhichCells(seuratObj, expression = CD3E > 0)
#'  CD20_positive <- WhichCells(seuratObj, expression = MS4A1 > 0)
#'  CD14_positive <- WhichCells(seuratObj, expression = CD14 > 0)
