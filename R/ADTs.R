...
triageADTsAndClassifyCells <- function(seuratObj,
  ...
  df <- .CalculateStatistics(seuratObj, assay, layer, libraryIdentificationColumn,
                             minimumCounts, minimumCells, plots, adtwhitelist, whitelist,
                             peakdist_sd_ratio, xdist_ratio_threshold)
  df <- .TriageADTs(df, minimumCells, peakdist_sd_ratio, peakheight_ratio_threshold, xdist_ratio_threshold)
  seuratObj <- .ClassifyCells(seuratObj, df, libraryIdentificationColumn, assay, layer, adtwhitelist)
